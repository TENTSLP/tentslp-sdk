...
var TokenType1 = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        nonSlpUtxos = balances.reduce(function (previousNonSlpUtxos, currentBalance, index) { return previousNonSlpUtxos.concat(currentBalance.result.nonSlpUtxos.map(function (utxo) { return (__assign({}, utxo, { wif: fundingWifs[index] })); })); }, []);
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        slpBatonUtxos = balanceWithBaton
                            ...
                            .map(function (utxo) { return (__assign({}, utxo, { wif: fundingWifs[balances.indexOf(balanceWithBaton)] })); });
                        inputUtxos = nonSlpUtxos.concat(slpBatonUtxos);
    ...
    TokenType1.prototype.estimatedFee = function (sendConfig) {
        return __awaiter(this, void 0, void 0, function () {
            var fundingAddresses, fundingWifs, network, BITBOX, bitboxNetwork, tokenId, bchChangeReceiverAddress, tokenInfo, tokenDecimals, amount, balances, nonSlpUtxos, slpTokenUtxos, inputUtxos, fee;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        // validate address formats
                    ...
                    case 2:
                        ...
                        nonSlpUtxos = balances.reduce(function (previousNonSlpUtxos, currentBalance, index) { return previousNonSlpUtxos.concat(currentBalance.result.nonSlpUtxos.map(function (utxo) { return (__assign({}, utxo, { wif: fundingWifs[index] })); })); }, []);
                        slpTokenUtxos = balances.reduce(function (previousSlpTokenUtxos, currentBalance, index) { return previousSlpTokenUtxos.concat((currentBalance.result.slpTokenUtxos[tokenId] || []).map(function (utxo) { return (__assign({}, utxo, { wif: fundingWifs[index] })); })); }, []);
                        if (slpTokenUtxos.length === 0)
                            throw new Error("Could not find any SLP token UTXOs");
                        inputUtxos = nonSlpUtxos.concat(slpTokenUtxos);
                        return [4 /*yield*/, bitboxNetwork.simpleTokenEstimatedFee(tokenId, amount, inputUtxos, sendConfig.tokenReceiverAddress, bchChangeReceiverAddress)];
                    case 3:
                        fee = _a.sent();
                        return [2 /*return*/, fee];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        nonSlpUtxos = balances.reduce(function (previousNonSlpUtxos, currentBalance, index) { return previousNonSlpUtxos.concat(currentBalance.result.nonSlpUtxos.map(function (utxo) { return (__assign({}, utxo, { wif: fundingWifs[index] })); })); }, []);
                        slpTokenUtxos = balances.reduce(function (previousSlpTokenUtxos, currentBalance, index) { return previousSlpTokenUtxos.concat((currentBalance.result.slpTokenUtxos[burnConfig.tokenId] || []).map(function (utxo) { return (__assign({}, utxo, { wif: fundingWifs[index] })); })); }, []);
                        inputUtxos = nonSlpUtxos.concat(slpTokenUtxos);
    ...
    TokenType1.prototype.returnBITBOXInstance = function (network) {
        ...
        var restURL;
        if (network === "mainnet")
            restURL = "https://rest.tent.app/v2/";
        else
            restURL = "https://trest.tent.app/v2/";
